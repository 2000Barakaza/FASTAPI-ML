...
def admin_page():
    ...
    # Link to the full admin panel (assuming the backend has the Admin mounted at /admin)
    st.markdown("### Advanced Admin Panel")
    st.markdown('[Open Full Admin Panel](http://127.0.0.1:8000/admin)')
